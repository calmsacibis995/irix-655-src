...
#ident "$Id: disk.c,v 1.20 1998/08/13 02:57:53 tes Exp $"
...
/* hinv.map.disk -- no support earlier than 6.4 */
  { 0, { PMID(1,80,13), PM_TYPE_NOSUPPORT, PM_INDOM_DISK, PM_SEM_DISCRETE, {0,0,0,0,0,0} } },
#else
/* hinv.map.disk */
  { 0, { PMID(1,80,13), PM_TYPE_STRING, PM_INDOM_DISK, PM_SEM_DISCRETE, {0,0,0,0,0,0} } },
#endif
/* hinv.disk_sn */
  { 0, { PMID(1,80,14), PM_TYPE_STRING, PM_INDOM_DISK, PM_SEM_DISCRETE, {0,0,0,0,0,0} } },
/*
 * Export as KBytes
 */
/* irix.disk.dev.bytes */
...
#else
/* irix.disk.dev.qlen */
  { 0, { PMID(1,80,21), PM_TYPE_NOSUPPORT, 0, 0, {0,0,0,0,0,0} } },
/* irix.disk.dev.sum_qlen */
  { 0, { PMID(1,80,22), PM_TYPE_NOSUPPORT, 0, 0, {0,0,0,0,0,0} } },
#endif
};
...
disk_fetch(pmID pmid, __pmProfile *profp, pmVPCB *vpcb)
{
 ...
 doit:
	...
	case PMID(1,80,14):		/* hinv.disk_sn */
	    av.cp = disk_stats[d].s_sn;
	    break;
#if !BEFORE_IRIX6_5
