...
czz_load_defs(gbkwc,,,cnv,stdlib_cnv_gbkwc.m4)
czz_load_defs(eucgbkwc,,,cnv,stdlib_cnv_eucgbkwc.m4)
...
czz_load_defs(wcgbkmbs,unsigned char,,out,stdlib_wcgbk_out.m4)
czz_load_defs(wceucgbkmbs,unsigned char,,out,stdlib_wceucgbk_out.m4)
