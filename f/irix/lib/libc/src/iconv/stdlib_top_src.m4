...
/* GBK mbtowc functions */

create_btowc_3(flb,gbkwc,flw)
create_mblen_3(flb,gbkwc,flw)
create_mbtowc_3(flb,gbkwc,flw)
create_mbstowcs_3(flb,gbkwc,flw)
create_wctob_2(flw,wcgbkmbs)
create_wctomb_2(flw,wcgbkmbs)
create_wcstombs_2(flw,wcgbkmbs)

create_ICONV_LIB_METHODS(gbk)

/* EUCGBK mbtowc functions */

create_btowc_3(flb,eucgbkwc,flw)
create_mblen_3(flb,eucgbkwc,flw)
create_mbtowc_3(flb,eucgbkwc,flw)
create_mbstowcs_3(flb,eucgbkwc,flw)
create_wctob_2(flw,wceucgbkmbs)
create_wctomb_2(flw,wceucgbkmbs)
create_wcstombs_2(flw,wceucgbkmbs)

create_ICONV_LIB_METHODS(eucgbk)
