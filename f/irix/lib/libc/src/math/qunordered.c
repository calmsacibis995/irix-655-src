 ...
 * $Author: vegas $
 * $Source: /proj/irix6.5f/isms/irix/lib/libc/src/math/RCS/qunordered.c,v $
 *
 * Revision history:
...
#ident	"$Header: /proj/irix6.5f/isms/irix/lib/libc/src/math/RCS/qunordered.c,v 1.2 1996/08/02 23:50:50 vegas Exp $"
