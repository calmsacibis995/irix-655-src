#ident "$Header: /proj/irix6.5f/isms/irix/cmd/icrash/cmds/RCS/cmd_utrace.c,v 1.4 1999/05/25 19:52:33 tjm Exp $"
			 ...
			 int flags)
{
	...
	while(rec_cnt) {
		...
		hiidx = 0;
		hiclk = kl_uint(list[hiidx].entry, "tstamp_event_entry", "tstamp", 0);
		for (i=1; i<cpu_cnt; i++) {
