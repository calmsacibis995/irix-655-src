...
#define AL_UNALIGNED_OK	0x08		/* Do not force alenlist_get() addr + */
					/* length to land on power of 2 boundary.   */
 ...
 */
extern alenlist_t alenlist_cursor_to_alenlist(alenlist_cursor_t cursorp);
