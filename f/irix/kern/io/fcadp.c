...
ushort command_list[COMMAND_INDEX_SIZE];
int command_index = 0;
#endif
...
#if FCADP_CMD_DEBUG
		command_list[command_index] = refblk.tcb_number;
...
#if FCADP_CMD_DEBUG
	command_list[command_index] = 10000 + tcbhdr->th_number;
	if (++command_index == COMMAND_INDEX_SIZE)
		command_index = 0;
#endif
	...
	struct fc_tcbhdr *tcbhdr)
{
	...
	/*
	 * Not a logout -- dump the frame for analysis
	 */
	else
	{
