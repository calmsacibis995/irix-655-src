...
#ident "$Id: flock_private.h,v 1.2 1999/05/14 20:13:13 lord Exp $"
...
struct flWait {
        ...
        sema_t          flw_sema;       /* semaphore on which the actual
					   wait will be done. */
...
extern int	cleanlocks_old(struct vnode *, pid_t, sysid_t, int);
