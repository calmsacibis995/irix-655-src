 ...
 * xscaninvent()
 *
 * Calls fun() for every entry in inventory list passing the vertex handle
 * along with the inventory information.  If fun() returns something
 * other than 0, return the error.
 */
