...
Change History        : Sept 19, 1997          HCL
					L-787 to L-820 :Default messages replaced as per
					Cataloguing GL
...
struct rexerr {
	...
	char	*dmsg;		/* default */
         ...
         * REVISIT
         * Date: 30/09/1997
         * ERR_SIZE macro used in the first entry of rexerr[] should
		 * be replaced by 0 otherwise message for ERR_SIZE will never
		 * be displayed .	
         */
static struct rexerr rexerr[] = {
	{ ERR_SIZE,	CAT_MSG_NUM(_MSG_LIBW_regexp_SIZE),
		DEF_MSG(_MSG_LIBW_regexp_SIZE)	},
	{ ERR_NORMBR,	CAT_MSG_NUM(_MSG_LIBW_regexp_NORMBR),
		DEF_MSG(_MSG_LIBW_regexp_NORMBR)			},
	{ ERR_REOVFLOW,	CAT_MSG_NUM(_MSG_LIBW_regexp_REOVFLOW),
		DEF_MSG(_MSG_LIBW_regexp_REOVFLOW)         },
	{ ERR_BRA,	CAT_MSG_NUM(_MSG_LIBW_regexp_BRA),
		DEF_MSG(_MSG_LIBW_regexp_BRA)         },
	{ ERR_DELIM,	CAT_MSG_NUM(_MSG_LIBW_regexp_DELIM),
		DEF_MSG(_MSG_LIBW_regexp_DELIM)         },
	{ ERR_NBR,	CAT_MSG_NUM(_MSG_LIBW_regexp_NBR),
        DEF_MSG(_MSG_LIBW_regexp_NBR)         }, 
	{ ERR_2MNBR,	CAT_MSG_NUM(_MSG_LIBW_regexp_2MNBR),
        DEF_MSG(_MSG_LIBW_regexp_2MNBR)         }, 
	{ ERR_DIGIT,	CAT_MSG_NUM(_MSG_LIBW_regexp_DIGIT),
        DEF_MSG(_MSG_LIBW_regexp_DIGIT)         }, 
	{ ERR_2MLBRA,	CAT_MSG_NUM(_MSG_LIBW_regexp_2MLBRA),
        DEF_MSG(_MSG_LIBW_regexp_2MLBRA)         }, 
	{ ERR_RANGE,	CAT_MSG_NUM(_MSG_LIBW_regexp_RANGE),
        DEF_MSG(_MSG_LIBW_regexp_RANGE)         }, 
	{ ERR_MISSB,	CAT_MSG_NUM(_MSG_LIBW_regexp_MISSB),
        DEF_MSG(_MSG_LIBW_regexp_MISSB)         }, 
	{ ERR_BADRNG,	CAT_MSG_NUM(_MSG_LIBW_regexp_BADRNG),
        DEF_MSG(_MSG_LIBW_regexp_BADRNG)         }, 
	{ ERR_SIMBAL,	CAT_MSG_NUM(_MSG_LIBW_regexp_SIMBAL),
        DEF_MSG(_MSG_LIBW_regexp_SIMBAL)         }, 
	{ ERR_SYNTAX,	CAT_MSG_NUM(_MSG_LIBW_regexp_SYNTAX),
        DEF_MSG(_MSG_LIBW_regexp_SYNTAX)         }, 
	{ ERR_ILLCLASS,	CAT_MSG_NUM(_MSG_LIBW_regexp_ILLCLASS),
        DEF_MSG(_MSG_LIBW_regexp_ILLCLASS)         }, 
	{ ERR_EQUIL,	CAT_MSG_NUM(_MSG_LIBW_regexp_EQUIL),
        DEF_MSG(_MSG_LIBW_regexp_EQUIL)         }, 
	{ ERR_COLL,	CAT_MSG_NUM(_MSG_LIBW_regexp_COLL),
        DEF_MSG(_MSG_LIBW_regexp_COLL)         }, 
	{ 0, 0, 0 },
};
