...
struct re_pattern_buffer
  {
    ...
    regex_t regstru; /* for regcomp */
    int err;     /* storing error code */
...
#if 0
 	/** Commented out due to interference with
	    definitions in re_comp.h
       	**/
...
extern char *mbRe_compile_pattern (char *, int, struct re_pattern_buffer *);
extern int mbRe_search (struct re_pattern_buffer *, char *, int);
