#ident "$Header: /proj/irix6.5f/isms/eoe/cmd/xfs/dump/restore/RCS/tree.c,v 1.19 1998/09/23 03:31:47 bbowen Exp $"
	       ...
	       char *path2 )
{
	 ...
	 * no references found (i.e., hard link list empty) and
	 */
	if ( path == path1 ) {
