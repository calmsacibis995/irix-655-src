...
#ident "$Header: /proj/irix6.5f/isms/eoe/cmd/xfs/dump/restore/RCS/getopt.h,v 1.12 1997/05/01 00:23:59 prasadb Exp $"
...
#define GETOPT_CMDSTRING	"a:b:c:ef:himn:op:rs:tv:ACDEFG:H:I:JL:M:NO:PQRS:TUVWX:Y:Z"
