#ident  "$Header: /proj/irix6.5f/isms/eoe/cmd/sss/configmon/RCS/configmon.c,v 1.8 1999/06/29 22:33:28 tjm Exp $"
...
{
	hw_component_t *dbcp, *lvcp, *next, *clone, *cp;
...
{
	int level, count = 0, flag = ALLOCFLG(cmp->flags);
...
{
	int change_type = 0, compare_flag = 0;
	int flag = K_TEMP;
	configmon_t *cmp;
