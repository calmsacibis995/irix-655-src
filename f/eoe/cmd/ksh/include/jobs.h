...
#   define job_terminate()	job_walk(job_kill,SIGHUP,(wchar_t**)0)
...
extern const char	e_running[];
extern const wchar_t	wc_e_nlspace[];
 ...
 */
    ...
    extern void job_bwait(wchar_t*[]);
    extern int	job_walk(int(*)(),int,wchar_t*[]);
