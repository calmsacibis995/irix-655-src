...
#define io_unreadc(c)	(st.peekn = (c))
...
struct filesave
{
   ...
   struct ionod;
    ...
    extern int		io_fopen(const wchar_t*);
    extern void 	io_sopen(wchar_t*);
...
extern wchar_t _SIbuf[];
extern wchar_t _SObuf[];
extern struct fileblk	io_stdin;
extern struct fileblk	io_stdout;
extern wchar_t	io_tmpname[];
...
extern const wchar_t	wc_e_devnull[];
extern const wchar_t	wc_e_profile[];
extern const wchar_t	wc_e_suidprofile[];
extern const wchar_t	wc_e_sysprofile[];
extern const wchar_t	wc_e_devfdNN[];
#ifdef SUID_EXEC
