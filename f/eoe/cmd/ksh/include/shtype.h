...
#define qotchar(c)	(c==L'`'||c==L'"')
/* #define eolchar(c)	(_ctype1[c]&(T_EOR)) */
#define eolchar(c)	(c==L'\n'||c==0L)
/* #define dipchar(c)	(_ctype1[c]&(T_DIP)) */
#define dipchar(c)	(c==L'|'||\
			c==L'('||\
			c==L'&'||\
			c==L';'||\
			c==L'>'||\
...
#define setchar(c)	(c==L'%'||\
			c==L'#'||\
			c==L'+')
/* #define	isalpha(c)	(_ctype2[c]&(T_UPC|T_LPC|T_ALP)) */
#define	is_walpha(c)	(iswalpha(c)||(c)==L'_'||isphonogram(c)||isideogram(c))
/* #define 	isalnum(c)	(_ctype2[c]&(_IDCH)) */
#define is_walnum(c)	(iswalnum(c)||(c)==L'_'||isphonogram(c)||isideogram(c))
/* #define 	isupper(c)	(_ctype2[c]&(T_UPC)) */
/* #define 	islower(c)	(_ctype2[c]&(T_LPC)) */
#define astchar(c)	((c)==L'*'||(c)==L'@')
