...
#else
	const wchar_t	*nv_name;
	const wchar_t	*nv_value;
#endif	/* apollo */
...
extern MSG	e_unlimited;
extern MSG	e_ulimit;
extern MSG	e_notdir;
extern MSG	e_direct;
extern WCMSG	wc_e_defedit;
#ifdef EMULTIHOP
    extern MSG	e_multihop;
#endif /* EMULTIHOP */
#ifdef ENAMETOOLONG
    extern MSG	e_longname;
#endif /* ENAMETOOLONG */
#ifdef ENOLINK
    extern MSG	e_link;
#endif /* ENOLINK */
