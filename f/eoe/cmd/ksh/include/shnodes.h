...
/*#define ARGVAL	((unsigned)(((struct argnod*)(&sh))->argval-((wchar_t*)(&sh)))) */
#define ARGVAL	offsetof(struct argnod,argval)
...
union anynode
{
    ...
    extern void 		sh_eval(wchar_t*);
    extern void 		sh_prompt(int);
    extern void 		sh_syntax(void);
    extern int			sh_trace(wchar_t**,int);
