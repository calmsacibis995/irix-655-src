/*
 * eoe/cmd/miser/libmiser/libmiser.h
...
#ifndef __MISER_UTIL_H__
#define __MISER_UTIL_H__
...
int                  miser_get_qstat(char *queue, int realstart);
...
void miser_print_block(int, miser_resources_t *first, miser_resources_t *last,
			int start);
