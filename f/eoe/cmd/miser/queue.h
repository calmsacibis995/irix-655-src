/*
 * eoe/cmd/miser/queue.h
 *	Miser queue resource management templete definitions.
 */
...
/* */
struct unfix_ctime : public binary_function <quanta_t, miser_seg_t, int>
{
        quanta_t start_time;
...
/* */
struct fix_ctime : public binary_function <quanta_t, miser_seg_t, int>
{
	quanta_t start_time;
