...
#ifndef ITERATOR_EXT_H
#define ITERATOR_EXT_H
template <class Container>
struct cyclic_iterator
	: random_access_iterator<Container::value_type,
				 Container::difference_type>
{
    ...
    Container::difference_type
	operator-(const cyclic_iterator<Container>& cmp) const
    {
...
cyclic_iterator<Container> cycler(Container& x, Iterator i) {
