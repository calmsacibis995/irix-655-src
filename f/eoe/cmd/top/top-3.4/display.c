...
double *avenrun;
{
    ...
    printf("%-30.30s %s ", uname_str, CATGETS(catd, _MSG_TOP_LOAD_AVERAGES));
...

{
    ...
    printf("%d %s", total, CATGETS(catd, _MSG_TOP_PROCESSES));
    ltotal = total;
...

{
	...
	{
	    fputs(CATGETS(catd, _MSG_TOP_PROCESSES), stdout);
	    /* put out enough spaces to get to column 15 */
	    i = digits(total);
	    while (i++ < 4)
	    {
