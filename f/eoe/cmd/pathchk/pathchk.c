 ...
 *--------------------------------------*/
const char msg_usage  []=MSGNUM_DEFMSG(_MSG_PATHCHK_USAGE);
const char e_lng_path []=MSGNUM_DEFMSG(_MSG_PATHNAME_LONGER_THAN_PATHMAX);
const char e_lng_comp []=MSGNUM_DEFMSG(_MSG_COMPONENT_LONGER_THAN_PATHMAX);
const char e_non_port []=MSGNUM_DEFMSG(_MSG_COMPONENT_CONTAINS_NONPORTABLE_CHAR);
const char e_nac_spath[]=MSGNUM_DEFMSG(_MSG_SUBPATH_IS_NOT_SEARCHABLE);
const char e_not_dir  []=MSGNUM_DEFMSG(_MSG_PATHSOFAR_IS_NOT_DIR);
const char e_miss_arg []=MSGNUM_DEFMSG(_MSG_MISSING_ARGUMENTS);
const char e_lak_mem  []=MSGNUM_DEFMSG(_MSG_LACK_OF_MEMORY);
const char e_err_prg  []=MSGNUM_DEFMSG(_MSG_PROGRAM_ERROR);
