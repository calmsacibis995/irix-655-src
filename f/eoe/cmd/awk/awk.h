/*
 *	$Id: awk.h,v 1.10 1998/09/18 19:47:22 sherwood Exp $
 */
...
Change History        :  25 October 1997       HCL
	New variable 'regex' of type 'regex_t' is added in
	structure 'fa' to maintain consistency with file
	'regex.c'.
