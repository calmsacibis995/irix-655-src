#ident  "$Header: /proj/irix6.5f/isms/eoe/lib/sss/libconfigmon/include/RCS/dbaccess.h,v 1.2 1999/05/08 04:34:47 tjm Exp $"
...
setup_dbquery(db_cmd_t *, int, k_uint_t, int, int, time_t);
