...
/* logical volume manager driver commands. */
#define DIOCGETVOLDEV	_DIOC_(36)	/* NEW: retrieve subvolume devices */
#define DIOCGETXLVDEV	_DIOC_(36)	/* OLD: retrieve XLV subvolume devices*/
#define DIOCGETSUBVOLINFO _DIOC_(37)	/* get subvolume info */
...
#define DIOCGETXLV      _DIOC_(45)      /* OLD: XLV logical volume desc */
#define DIOCGETVOL	_DIOC_(45)	/* NEW: get volume subvolume info */
#define DIOCMKALIAS	_DIOC_(46)	/* make aliases /hw/disk/dks#d#l#s#  &&
					 *             	/hw/rdisk/dks#d#l#s# 
					 */
#define DIOCGETVOLSTRIPE _DIOC_(47)	/* return subvolume stripe info */
