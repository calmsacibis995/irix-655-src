...
#ident	"libdisk/diskinfo.h $Revision: 1.26 $"
...
void get_subvol_stripe_wrapper(char *dfile, int type, int *sunit, int *swidth);
void xlv_get_subvol_stripe(char *dfile, int type, int *sunit, int *swidth);
void xvm_get_subvol_stripe(char *dfile, int type, int *sunit, int *swidth);
