...
static void    *heapzone_realloc(void *, size_t, int, cnodeid_t);
...
kmem_realloc(register void *ptr, register size_t nbytes, int flags)
{
	...
	ret = heapzone_realloc(ptr, nbytes, flags, CNODEID_NONE);
...
kern_realloc(register void *ptr, register size_t nbytes)
{
	...
	ret = heapzone_realloc(ptr, nbytes, 0, CNODEID_NONE);
...
kmem_realloc_node(register void *ptr, register size_t nbytes, int flags, cnodeid_t node)
{
	...
	ret = heapzone_realloc(ptr, nbytes, flags|NODE_SPECIFIC_FLAG, node);
 ...
 */
static void *
heapzone_realloc(void *ptr, size_t size, int vmflags, cnodeid_t node)
{
