...
{
	ts->tv_sec = t / timer_freq;
	ts->tv_nsec = (t % timer_freq) * timer_unit;
}
 ...
 */
void
ktimer_init(kthread_t *kt, unsigned int timer)
{
	ktimerpkg_t *kp;
 ...
 */
void
ktimer_switch(kthread_t *kt, unsigned int newtimer)
{
	ktimerpkg_t *kp;
	ktimersnap_t snap;
	int curtimer;
 ...
 */
static __inline uint64_t
_ktimer_readticks(const kthread_t *kt, unsigned int timer)
{
...
uint64_t
ktimer_readticks(const kthread_t *kt, unsigned int timer)
{
 ...
 */
void
ktimer_read(const kthread_t *kt, unsigned int timer, timespec_t *ts)
{
 ...
 */
uint64_t
ktimer_accum(kthread_t *kt, unsigned int timer, uint64_t ticks)
{
	ktimerpkg_t *kp;
