...
#define P_PROXY		0x10000000	/* pfdat is a proxy for remote page */
#define P_BULKDATA	0x20000000	/* buffer cache, mbufs, etc */
#define	P_HWSBE		0x40000000	/* page has SBE */

/*
 * Mask for all flags except P_BITLOCK and P_PROXY
 */

#define P_ALLFLAGS      0x27FFFFFF
