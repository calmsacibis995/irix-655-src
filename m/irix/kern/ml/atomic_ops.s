...
#if (SIZEOF_CPUMASK == 8) && (_MIPS_SZLONG == 32)
	# 64-bit cpumask and a 32-bit kernel 
	move	v1,v0
	dsra	v0,32
	dsll	v1,32			# sign-extend v1
	dsra	v1,32
#endif
	# Return to caller
	j	ra
...
#if defined(R10K_LLSC_WAR) ||(!defined(_COMPILER_VERSION) || (_COMPILER_VERSION<700) || (_COMPILER_VERSION>700)) /* !Mongoose */
/*
