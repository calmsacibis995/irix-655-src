#ident "$Header: /proj/irix6.5m/isms/irix/cmd/icrash/cmds/RCS/cmd_pfdat.c,v 1.21 1999/05/25 19:21:38 tjm Exp $"
...
sn0_compact_to_nasid_node(int cnode)
{
	...
	Pcompact_to_nasid_node = 
		kl_alloc_block(((int)size * SN0_MAX_COMPACT_NODES), K_TEMP);
...
sn0_nasid_to_compact_node(int nnode)
{
	...
	Pnasid_to_compact_node = 
		kl_alloc_block((int)size * SN0_MAX_NASIDS, K_TEMP);
