 ...
 * $Author: wtk $
 * $Source: /proj/irix6.5m/isms/irix/lib/libc/src/math/RCS/tenscalec.c,v $
 *
 * Revision history:
...
static char *rcs_id = "$Source: /proj/irix6.5m/isms/irix/lib/libc/src/math/RCS/tenscalec.c,v $ $Revision: 1.3 $";
#endif
