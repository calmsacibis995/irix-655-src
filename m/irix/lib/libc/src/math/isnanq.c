 ...
 * $Author: vegas $
 * $Source: /proj/irix6.5m/isms/irix/lib/libc/src/math/RCS/isnanq.c,v $
 *
 * Revision history:
...
#ident	"$Header: /proj/irix6.5m/isms/irix/lib/libc/src/math/RCS/isnanq.c,v 1.2 1996/08/02 23:49:47 vegas Exp $"
