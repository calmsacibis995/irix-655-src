...
/* ------------------------------------------------------------------------- */
/* SSS Server Daemon version definition                                      */
#define SSRV_VMAJOR                        1     /* SSS Server Daemon major version number */
#define SSRV_VMINOR                        4     /* SSS Server Daemon minor version number */
/* ------------------------------------------------------------------------- */
...
#define SSRV_OPEN_ALLCONNECTION           1
/* ------------------------------------------------------------------------- */
/* Include SSDB */
#define SSRV_SSDB_INCLUDE                 1
/* ------------------------------------------------------------------------- */
/* Enable "Switcher" interface support */
#define SSRV_SWITCHER_ON                  1
/* ------------------------------------------------------------------------- */
/* Enable command string key 'p' (change resource path) */
#define SSRV_ENABLE_CHANGE_RESPATH        1
/* ========================================================================= */

/* ------------------------------------------------------------------------- */
#define SSRV_DEFAULT_RESOURCESPATH   "/var/esp/ssc"      /* Default Server resources path */
#define SSRV_DEFAULT_SWITCHLIBPATH   "/usr/lib32/internal/libssrvswitch.so" /* Default "Switcher" library path and name*/
#define SSRV_DEFAULT_LISTENPORT      5555                /* Default port for listen */
#define SSRV_APPLICATION_NAME        "esphttpd"          /* Application name */
