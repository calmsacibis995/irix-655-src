#ident "$Header: /proj/irix6.5m/isms/eoe/cmd/rfind/fsdump/RCS/jdm.c,v 1.3 1997/06/17 19:08:40 doucette Exp $"
...
/* Just always compile this version for BANYAN */
#define	BANYAN
...
jdm_getfshandle( char *mntpnt )
{
	...
	assert( sizeof( filehandle_t )
		-
		offsetofmember( filehandle_t, fh_pad1[0] )
		==
