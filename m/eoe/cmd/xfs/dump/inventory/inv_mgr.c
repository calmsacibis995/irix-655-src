#ident "$Header: /proj/irix6.5m/isms/eoe/cmd/xfs/dump/inventory/RCS/inv_mgr.c,v 1.21 1996/04/23 01:20:49 doucette Exp $"
	...
	search_callback_t func)
{
	...
	*outarg = NULL; 
	...
	for ( i = 0; i < numfs; i++) {
		...
		result = search_invt( invfd, inarg, outarg, func );
		close(invfd);		
