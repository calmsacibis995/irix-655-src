...
#   else /* __GC */
	  void unref_nonnil() {}
	  void ref_nonnil() {}
	  static void unref(__rope_RopeBase*) {}
	  static void ref(__rope_RopeBase*) {}
	  static void fn_finalization_proc(void * tree, void *);
	  static void free_if_unref(__rope_RopeBase*) {}
#   endif
...
#       else /* __GC */
	  static void unref(RopeBase*) {}
	  static void ref(RopeBase*) {}
#       endif
...
inline ptrdiff_t operator-(const __rope_const_iterator<charT,Alloc> & x,
			   const __rope_const_iterator<charT,Alloc> & y) {
	return (ptrdiff_t)x.current_pos - (ptrdiff_t)y.current_pos;
}
