...
class VkComponentList : public VkComponent {
  ...
  public:
     ...
     virtual void removeFirst(VkComponent *);
     virtual void removeLast(VkComponent *);
     int size() const { return _numComponents; }
     VkComponent *operator[]  (int index)   const;

     int contains(VkComponent *);
  ...
  private:
    ...
    VkComponentList(const VkComponentList&);
    VkComponentList &operator= (const VkComponentList&);
};
#endif
