 ...
 * Motif Release 1.2.4
*/ 
/*   $RCSfile: Xm.h,v $ $Revision: 0.6 $ $Date: 1995/09/08 15:40:56 $ */
/*
...
#else /* SGI addtiions */
/*
 * The Xm3D stuff is an error.
 * This needs to be cleaned up to be in the SGI name space at the first chance.
 * e.g. Sg3D_N_OF_MANY
 */
enum{	XmN_OF_MANY = 1,		XmONE_OF_MANY,
	Xm3D_N_OF_MANY,                 Xm3D_ONE_OF_MANY
#endif /* __sgi */
	} ;
/************************************************************************
 *  Form defines
...
#ifdef __sgi
/*
 * These names are a mistake.
 * They must be changed to be in the SGI namespace at the first opportunity.
 * E.g. SgNOT_ADJACENT
 * to honor our commitments not to pollute either OSF or customers' name
 * spaces.
 */
enum{ XmNOT_ADJACENT,  XmLEFT_ADJACENT, XmRIGHT_ADJACENT ,
      XmTOP_ADJACENT,  XmBOTTOM_ADJACENT };

enum { XmNORMAL_ARROWS,XmROTATE_ARROWS,XmNO_THUMB_WHEN_EMPTY};
#endif /* __sgi */
