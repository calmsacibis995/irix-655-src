...
#ifndef __MISER_PUBLIC_HEADER__
#define __MISER_PUBLIC_HEADER__
...
#define MISER_EXCEPTION_TERMINATE		0x001
#define MISER_EXCEPTION_SUSPEND			0x002
#define MISER_EXCEPTION_WEIGHTLESS		0x004
#define MISER_EXCEPTION_CALLBACK		0x008
#define MISER_EXCEPTION_SELF_PAGE		0x010
#define MISER_EXCEPTION_ADVANCE			0x020
#define MISER_SEG_DESCR_FLAG_STATIC		0x040
#define MISER_SEG_DESCR_FLAG_NORMAL		0x080

#define MISER_CPUSET_CPU_EXCLUSIVE		0x100
#define MISER_CPUSET_KERN			0x200
#define MISER_CPUSET_MEMORY_LOCAL		0x400
#define MISER_CPUSET_MEMORY_EXCLUSIVE		0x800
