...
#define RGPERR_SUCCESS          0  /* Success return code */
#define RGPERR_NEEDPERMISSION   1  /* User/Request need additional permissions */
#define RGPERR_REDIRECTED       2  /* Redirected */
